...
def runGame(data):
    ...
    while True: # game loop
        ...
        if event == sf30.START_PRESSED: # buttons.checkKey ("Start"):
        ...
        movingRight = False
        movingDown = False
        if event==sf30.SELECT_PRESSED: # buttons.checkKey ("Select"): #Pause
        ...
        if event == sf30.A_PRESSED: # buttons.checkKey ("A"):
            ...
            if not isValidPosition(board, fallingPiece):
                fallingPiece['rotation'] = (fallingPiece['rotation'] - 1) % len(PIECES[fallingPiece['shape']])
        if event == sf30.B_PRESSED: # buttons.checkKey ("B"):
            fallingPiece['rotation'] = (fallingPiece['rotation'] - 1) % len(PIECES[fallingPiece['shape']])
            if not isValidPosition(board, fallingPiece):
                fallingPiece['rotation'] = (fallingPiece['rotation'] + 1) % len(PIECES[fallingPiece['shape']])
