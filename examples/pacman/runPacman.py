...
while keepGoing_game:
    ...
    while keepGoing_round:
        ...
        if event == sf30.LEFT_PRESSED: # buttons.checkKey ("Left"):   
            ...
            pacman.direction = 1
            foundButtons = True
        elif event == sf30.RIGHT_PRESSED: # buttons.checkKey ("Right"):
            pacman.moveRight = True
            pacman.moveUp = pacman.moveLeft = pacman.moveDown = False
            pacman.direction = 3        
            foundButtons = True
        elif event == sf30.UP_PRESSED: # buttons.checkKey ("Up"):
            pacman.moveUp = True
            pacman.moveLeft = pacman.moveDown = pacman.moveRight = False
            pacman.direction = 0
            foundButtons = True
        elif event == sf30.DOWN_PRESSED: # buttons.checkKey ("Down"):
            pacman.moveDown = True
            pacman.moveUp = pacman.moveLeft = pacman.moveRight = False
            pacman.direction = 2
            foundButtons = True
        elif event == sf30.SELECT_PRESSED: # buttons.checkKey ("Select"):
            terminate()
        elif foundButtons:
