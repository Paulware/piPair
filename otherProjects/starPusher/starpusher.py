...
WINHEIGHT = 320 # height in pixels
...
def runLevel(levels, levelNum):
    ...
    while True: # main game loop
        ...
        if event == sf30.START_PRESSED: # event.type == QUIT:
            # Player clicked the "X" at the corner of the window.
            terminate()

        elif event == sf30.LEFT_PRESSED: 
            playerMoveTo = LEFT
        elif event == sf30.RIGHT_PRESSED:
            playerMoveTo = RIGHT
        elif event == sf30.UP_PRESSED:
            playerMoveTo = UP        
        elif event == sf30.DOWN_PRESSED:        
            playerMoveTo = DOWN
        '''    
